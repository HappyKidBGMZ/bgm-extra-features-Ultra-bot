...
async def aboutme(client, message):
        buttons= [[
            InlineKeyboardButton('♥️ 𝐒𝐇𝐀𝐑𝐄 𝐌𝐄 ♥️', url='https://telegram.me/share/url?url=https://telegram.dog/bgm_linkzz')
            ],[
...
async def who_is(client, message):
    ...
    if chat_photo:
        ...
        buttons = [[
            InlineKeyboardButton('❣️ 𝐂𝐋𝐎𝐒𝐄 ❣️', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(

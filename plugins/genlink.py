...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("𝚄𝚂𝙴 𝙲𝙾𝚁𝚁𝙴𝙲𝚃 𝙵𝙾𝚁𝙼𝙰𝚃.\n𝙴𝚇𝙰𝙼𝙿𝙻𝙴 ›› <code>/batch https://t.me/BGM_LinkzZ/3 https://t.me/BGM_LinkzZ/8</code>.")
    links = message.text.strip().split(" ")
    if len(links) != 3:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/BGM_LinkzZ/3Fonts for Android and iPhone  - www.fontskeyboard.com/share-now https://t.me/BGM_LinkzZ/8</code>.")
